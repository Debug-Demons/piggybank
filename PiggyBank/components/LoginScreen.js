...
const LoginScreen = ({ navigation}) => {
  ...
  const handleLogin = async () => {
    //TEST HOMEPAGE
    //navigation.replace('Business', {username})                   // navigation. replace makes it so that no back button
    navigation.navigate('Business', {username})       // this gives back button 
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Create New Account" onPress={ () => navigation.navigate('POS')} />
    </View>
  );
};
